...
textArea.style.padding = ".5rem 1 rem"
...
//keyup dispara ao soltar qualquer tecla do teclado
...
const appendTweet = (tweet) => {
    ...
    tweetAvatar.style.innerHTML = getInitials(username)
    ...
    //Sempre o último tweet mais acima
